...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='增量配置';
...
CREATE TABLE IF NOT EXISTS `config_tags_relation` (
  ...
  `nid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'nid, 自增',
  PRIMARY KEY (`nid`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='集群、各Group配量信息表';
...
CREATE TABLE IF NOT EXISTS `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='多租户改动记录表';
